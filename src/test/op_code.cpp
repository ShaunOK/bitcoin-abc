...
BOOST_AUTO_TEST_CASE(op_and) {
    test_and(SCRIPT_ENABLE_OPCODES0);
    test_and(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_and(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_and(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_or) {
    test_or(SCRIPT_ENABLE_OPCODES0);
    test_or(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_or(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_or(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_xor) {
    test_xor(SCRIPT_ENABLE_OPCODES0);
    test_xor(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_xor(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_xor(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_div) {
    test_div(SCRIPT_ENABLE_OPCODES0);
    test_div(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_div(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_div(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_mod) {
    test_mod(SCRIPT_ENABLE_OPCODES0);
    test_mod(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_mod(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_mod(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_cat) {
    test_cat(SCRIPT_ENABLE_OPCODES0);
    test_cat(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_cat(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_cat(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_split) {
    test_split(SCRIPT_ENABLE_OPCODES0);
    test_split(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_split(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_split(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(cat_split) {
    test_cat_split(SCRIPT_ENABLE_OPCODES0);
    test_cat_split(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_cat_split(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_cat_split(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_bin2num) {
    test_bin2num(SCRIPT_ENABLE_OPCODES0);
    test_bin2num(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_bin2num(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_bin2num(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(op_num2bin) {
    test_num2bin(SCRIPT_ENABLE_OPCODES0);
    test_num2bin(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_num2bin(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_num2bin(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);

}

BOOST_AUTO_TEST_CASE(bin2num_num2bin) {
    test_bin2num_num2bin(SCRIPT_ENABLE_OPCODES0);
    test_bin2num_num2bin(STANDARD_SCRIPT_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_bin2num_num2bin(STANDARD_NOT_MANDATORY_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
    test_bin2num_num2bin(STANDARD_LOCKTIME_VERIFY_FLAGS | SCRIPT_ENABLE_OPCODES0);
}

BOOST_AUTO_TEST_CASE(num2bin_bin2num) {
    test_num2bin_bin2num(SCRIPT_ENABLE_OPCODES0);
